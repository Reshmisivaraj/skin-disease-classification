...
Original file is located at
    https://colab.research.google.com/drive/1ownq8lIgz2wyAfaWqwFMGIJ4dWlgmhkJ
"""
...
if __name__ == "__main__":
    flag = True
    print("Hello, there my name is Virohana. I will answer your queries. If you want to exit, type Bye!")
    while(flag==True):
        user_response = input()
